...
const fetchAddress = () => {
    //newでインスタンス化します。
    //第1引数はString(form.postcode)で入力した郵便番号を文字列で取得します。
    //第2引数がコールバックで引数の中に住所の情報が入ってきます。
    new YubinBangoCore(String(form.postcode),(value)=>{
        //value.region、value.locality、value.streetは郵便番号で検索された県、市、と番地前までの値が入る。
        //form.addressに値を入れる。
                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    //@change="fetchAddress"で中の内容が変わって、カーソルが外れた時に実行する
